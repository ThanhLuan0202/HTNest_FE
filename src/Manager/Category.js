  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      name: Yup.string()
        ...
        .matches(
          /^[a-zA-Z\sÀ-Ỹà-ỹ]*$/,
          "Tên danh mục không được chứa ký tự đặc biệt hoặc số"
        )
      ...
      categoryCode: Yup.string()
        ...
        .matches(
          /^LSP\d{4}$/,
          "Mã danh mục phải bắt đầu bằng 'LSP' và sau đó là 4 chữ số"
        )
        .matches(
          /^[a-zA-Z0-9\sÀ-Ỹà-ỹ]*$/,
          "Tên danh mục không được chứa ký tự đặc biệt hoặc số"
  ...
  return (
    <div className="col-10">
      ...
      <div className="category">
        <div
          className={`alert alert-success position-fixed  notify-item-add-success align-items-center addCate ${
            addSuccess ? "open" : ""
          }`}
        >
        ...
        <div
          className={`alert alert-success position-fixed  notify-item-delete-success align-items-center deleteCate ${
            deleteSuccess ? "open" : ""
          }`}
        >
        ...
        <div
          className={`alert alert-success position-fixed  notify-item-update-success align-items-center updateCate ${
            updateSuccess ? "open" : ""
          }`}
        >
          <i className="fas fa-check-circle me-2 dai"></i>
          ...
          <form onSubmit={formikUpdate.handleSubmit}>
            <div className="modal-category-body-update">
              ...
              <input
                ...
                placeholder="Ví dụ: LSPxxxx"
              />
              {formikUpdate.touched.categoryCode &&
              formikUpdate.errors.categoryCode ? (
                <span className="error ercate">
                  {formikUpdate.errors.categoryCode}
                </span>
              ) : null}
